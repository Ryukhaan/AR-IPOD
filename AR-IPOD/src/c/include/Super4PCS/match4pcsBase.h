...
protected:
    ...
    /// computation.
    /// @param [in] P First input set.
    /// @param [in] Q Second input set.
    ...
    /// @param [in] pair_normal_angle The angle between the normals of the pair
    /// in P.
    ...
    /// input base.
    /// \param [out] number of quads corresponding to valid configurations
    template <typename Visitor>
